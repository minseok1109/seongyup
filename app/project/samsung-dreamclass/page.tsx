...
const Page = () => {
  return (
    <div>
      <ProjectHeader
        title={'SAMSUNG DREAMCLASS ―ONLINE LEARNING PROGRAM PROJECT'}
      />
      <div className="flex flex-col gap-4">
        ...
        <p className="indent-8">
          ...
          facing difficulties in pursuing their dreams and developing
          aspirations and capacity for their future careers. Dreamclass offers a
          blended learning experience, both online and offline, where students
          cultivate essential competencies needed in the era of the Fourth
          Industrial Revolution through various learning activities.
        </p>
        <p className="indent-8">
          ...
          tiered instruction on core reading strategies to enhance literacy
          skills and thematic reading. It is aimed to expand thinking and
          expression through books as source material.
        </p>
        <p className="indent-8">
          In 2022, the Dreamclass 'Reading Program' utilized ZEP to create a
          Metaverse learning environment. Each team was composed of an
          instructor, an instructional supporter, and 6 to 8 students. Learning
          took place in the Metaverse as students followed the instructor's
          guidance, engaging in activities like reading texts, watching videos,
          participating in discussions and interactive games.
        </p>
      </div>
